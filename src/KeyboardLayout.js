...
export const KEYBOARD_LAYOUT = [
  ...
  { code: 'Space', label: '', width: 6.5, x: 4.25, y: 4, color: 'accentYellow' },
  { code: 'MetaRight', label: '⌘', subLabel: 'command', width: 1.25, x: 10.75, y: 4, color: 'modKeys' },
  { code: 'AltRight', label: '⌥', subLabel: 'option', width: 1, x: 12, y: 4, color: 'modKeys' },
