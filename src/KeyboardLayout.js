...
export const KEYBOARD_LAYOUT = [
  ...
  { code: 'Digit1', label: '1', width: 1, x: 1, y: 0, color: 'alphaKeys' },
  { code: 'Digit2', label: '2', width: 1, x: 2, y: 0, color: 'alphaKeys' },
  { code: 'Digit3', label: '3', width: 1, x: 3, y: 0, color: 'alphaKeys' },
  { code: 'Digit4', label: '4', width: 1, x: 4, y: 0, color: 'alphaKeys' },
  { code: 'Digit5', label: '5', width: 1, x: 5, y: 0, color: 'alphaKeys' },
  { code: 'Digit6', label: '6', width: 1, x: 6, y: 0, color: 'alphaKeys' },
  { code: 'Digit7', label: '7', width: 1, x: 7, y: 0, color: 'alphaKeys' },
  { code: 'Digit8', label: '8', width: 1, x: 8, y: 0, color: 'alphaKeys' },
  { code: 'Digit9', label: '9', width: 1, x: 9, y: 0, color: 'alphaKeys' },
  { code: 'Digit0', label: '0', width: 1, x: 10, y: 0, color: 'alphaKeys' },
  { code: 'Minus', label: '-', width: 1, x: 11, y: 0, color: 'alphaKeys' },
  { code: 'Equal', label: '=', width: 1, x: 12, y: 0, color: 'alphaKeys' },
  { code: 'Backspace', label: '⌫', width: 2, x: 13, y: 0, color: 'modKeys' },
  { code: 'Home', label: 'Home', width: 1, x: 15, y: 0, color: 'modKeys' },

  // Row 1 - QWERTY row
  { code: 'Tab', label: 'Tab', width: 1.5, x: 0, y: 1, color: 'modKeys' },
  ...
  { code: 'BracketLeft', label: '[', width: 1, x: 11.5, y: 1, color: 'alphaKeys' },
  { code: 'BracketRight', label: ']', width: 1, x: 12.5, y: 1, color: 'alphaKeys' },
  { code: 'Backslash', label: '\\', width: 1.5, x: 13.5, y: 1, color: 'modKeys' },
  { code: 'PageUp', label: 'PgUp', width: 1, x: 15, y: 1, color: 'modKeys' },

  // Row 2 - Home row
  { code: 'CapsLock', label: 'Caps', width: 1.75, x: 0, y: 2, color: 'modKeys' },
  ...
  { code: 'Semicolon', label: ';', width: 1, x: 10.75, y: 2, color: 'alphaKeys' },
  { code: 'Quote', label: "'", width: 1, x: 11.75, y: 2, color: 'alphaKeys' },
  { code: 'Enter', label: 'Enter', width: 2.25, x: 12.75, y: 2, color: 'accentOrange' },
  { code: 'PageDown', label: 'PgDn', width: 1, x: 15, y: 2, color: 'modKeys' },

  // Row 3 - Shift row
  { code: 'ShiftLeft', label: 'Shift', width: 2.25, x: 0, y: 3, color: 'modKeys' },
  ...
  { code: 'Comma', label: ',', width: 1, x: 9.25, y: 3, color: 'alphaKeys' },
  { code: 'Period', label: '.', width: 1, x: 10.25, y: 3, color: 'alphaKeys' },
  { code: 'Slash', label: '/', width: 1, x: 11.25, y: 3, color: 'alphaKeys' },
  { code: 'ShiftRight', label: 'Shift', width: 1.75, x: 12.25, y: 3, color: 'modKeys' },
  { code: 'ArrowUp', label: '↑', width: 1, x: 14, y: 3, color: 'modKeys' },
  { code: 'End', label: 'End', width: 1, x: 15, y: 3, color: 'modKeys' },

  // Row 4 - Bottom row
  { code: 'ControlLeft', label: 'Ctrl', width: 1.25, x: 0, y: 4, color: 'modKeys' },
  { code: 'MetaLeft', label: 'Sup', width: 1.25, x: 1.25, y: 4, color: 'modKeys' },
  { code: 'AltLeft', label: 'Alt', width: 1.25, x: 2.5, y: 4, color: 'modKeys' },
  { code: 'Space', label: '', width: 6.25, x: 3.75, y: 4, color: 'accentYellow' },
  { code: 'AltRight', label: 'Alt', width: 1, x: 10, y: 4, color: 'modKeys' },
  { code: 'MetaRight', label: 'Sup', width: 1, x: 11, y: 4, color: 'modKeys' },
